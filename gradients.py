...
def compute_manual_gradient(model, loss_fn, states_t, actions_t, target_q, grad_config):
    """
    ...
    if method == 'finite-diff':
        _compute_finite_diff(model, loss_fn, states_t, actions_t, target_q, grad_config)
    elif method == 'spsa':
        _compute_spsa(model, loss_fn, states_t, actions_t, target_q, grad_config)
    else:
        raise ValueError(f"Unknown manual gradient method: {method}")

def _compute_finite_diff(model, loss_fn, states_t, actions_t, target_q, grad_config):
    """
...
def _compute_spsa(model, loss_fn, states_t, actions_t, target_q, grad_config):
    """
